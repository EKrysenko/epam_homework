...
import static codingbat.WarmUp1.isWithin;
...
public class Logic1 {
    ...
    public static boolean in1To10(int n, boolean outsideMode) {
        return outsideMode ? !isWithin(n, 2, 9) : isWithin(n, 1, 10);
    }
    ...
    public static boolean squirrelPlay(int temp, boolean isSummer) {
        return isSummer ? isWithin(temp, 60, 100) : isWithin(temp, 60, 90);
    }
    ...
    public static String alarmClock(int day, boolean vacation) {
        boolean isWeekdays = isWithin(day, 1, 5);
        if (!isWeekdays && vacation) {
            return "off";
        }
        if ((isWeekdays && vacation) ||
                (!isWeekdays && !vacation)){
    ...
    public int sumLimit(int a, int b) {
        ...
        return aLength == sumLength ? a + b : a;
    }
