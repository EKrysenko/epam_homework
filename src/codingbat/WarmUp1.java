...
public class WarmUp1 {
     ...
     * or35(8) → false
     */
    public static boolean or35(int n){  // Problem "startOz" solve method.
        return n % 3 == 0 || n % 5 == 0;
    }
    ...
    */
    ...
    public static String front22(String str){
        return getFront(str, 2) + str + getFront(str, 2);
    }
    ...
    public static boolean in1020(int a, int b){
        return isWithin(a, 10, 20) || isWithin(b, 10, 20);
    }
