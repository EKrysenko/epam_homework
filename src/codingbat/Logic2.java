...
public class Logic2 {
     ...
     * is less than 5, so 12 rounds down to 10. Given 3 ints, a b c,
     ...
     *(differing from a by at most 1), while the other is "far", differing from both other
    ...
    public int makeChocolate(int small, int big, int goal) {
        ...
        return (goal / 5 <= big) ? goal % 5 : goal - big * 5;
    }
}
