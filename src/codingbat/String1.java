...
public class String1 {
    ...
    public static String startWord(String str, String word) {
        ...
        String front = str.substring(0, lenW);
        String shortS = str.substring(1, lenW);
        String shortW = word.substring(1, lenW);

        if(front.equals(word)){
            return word;
        }
        if(shortS.equals(shortW)){
            return front;
        }
        return "";
    }
    ...
    public static String conCat(String a, String b) {
        if(hasDoubleChar(a, b)){
            return a.substring(0, a.length() - 1).concat(b);
        }
        return a.concat(b);
    }
    private static boolean hasDoubleChar(String a, String b) { // Util method returns true if last char
    ...
    public static String without2(String str) {
        ...
        String front = str.substring(0, 2);
        String back = str.substring(len - 2, len);
        return (front.equals(back) ? str.substring(2, len) : str);
    }
    ...
    public static String withoutX(String str) {
        if (str.equals("") || str.equals("x") || str.equals("xx")) {
            return "";
        }
        if (str.charAt(0) == 'x') {
            str = str.substring(1);
    ...
    public static String makeTags(String tag, String word) {
        return addBrac(tag, 1) + word + addBrac(tag, 2);
    }
    public static String addBrac(String tag, int i) { // Util method makes tag-braces around string tag.
        switch(i){
            case 1:
                return "<" + tag + ">";
            case 2:
